...
<div class="home">
  ...
  <div id="app">
    ...
    <button type="button" name="button" v-on:click="show = !show">Click for Tips!</button>
  </div>

  <div class="container">
    <div v-if="show" class="container bg-warning mb-2">
      <!--Blithering tech talk generated by textfixer.com.-->
      <h2>A Guide to Solving Web Development Problems</h2>
      ...
      <p>Half the technical problems in web development are caused by something trivial like forgetting a semi-colon somewhere and are usually easily solvable if you've had your coffee but for all the problems past this level, you'll probably need
        to do some structured thinking.</p>
      ...
      <p>Example: A form that submitted customer leads wasn't working. My first question was &quot;How come the forms aren't working&quot; - which was not defined enough to start solving the problem. So I sent a test copy of the form live and that
        copy worked so the question became &quot;how come the lead generating forms aren't working on the preview server&quot;. Just the slight change in the question completely changed how I tackled the problem.</p>
